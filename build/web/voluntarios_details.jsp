            ...
            <form action="app" method="post">
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="hidden" name="action" value="editV">
                        <input type="hidden" name="id" value="${voluntario.id}">
                        <input type="text" class="form-control" placeholder="Nombre" name="name" required value="${voluntario.nombre}">
                    </div>
                    <div class="col-md-6 mb-3">
                        <label for="lastname">Apellido</label>
                        <input type="text" class="form-control" placeholder="Apellido" name="lastname" required value="${voluntario.apellido}">
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-6 mb-3">
                        <label for="email">Email</label>
                        <input type="email" class="form-control" placeholder="Email" name="email" required value="${voluntario.email}">
                    </div>
                    <div class="col-md-6 mb-3">
                        <label for="address">Domicilio</label>
                        <input type="text" class="form-control" placeholder="Domicilio" name="address" required value="${voluntario.domicilio}">
                    </div>
                </div>
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" class="form-control" placeholder="Código Postal" name="zip" required value="${voluntario.zip}">
                    </div>
                    <div class="col-md-6 mb-3">
                        <label for="zip">Telefono</label>
                        <input type="text" class="form-control" placeholder="Telefono" name="tel" required value="${voluntario.telefono}">
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-6 mb-3">
